    ...
    write_parquet(df_favourite,   "/Users/hhs/Dropbox/Bucket/fpl2526/data/fplplayer_favourite.parquet")
    write_parquet(df_history,     "/Users/hhs/Dropbox/Bucket/fpl2526/data/fplplayer_history.parquet")
    write_parquet(df_leagues,     "/Users/hhs/Dropbox/Bucket/fpl2526/data/fplplayer_leagues.parquet")
    write_parquet(df_entryseason, "/Users/hhs/Dropbox/Bucket/fpl2526/data/fplplayer_points.parquet")
